...
//      EnglishAnalyzer analyzer = new EnglishAnalyzer();
      ...
      /*w.addDocument(buildDoc("Lucene in Action", "9781473671911"));
        ...
        // ZAD 7
            String querystr = "*:*";
            String querystr = "dummy"; // 1 result
            String querystr = "and"; // 1 result
        */

        /* 
        // ZAD 9
            String querystr = "dummy"; // 2 results
            String querystr = "and"; // 0 results
        */

        /* 
        // ZAD 12
            S// String querystr = "isbn:9780062316097"; // 1 result
